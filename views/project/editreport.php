...
<form method="post" action="<?php echo build_url('project', 'savereport');?>">
...
<?php if ($this->model->id): ?>
<form method="post" action="<?php echo build_url('project', 'generatereport');?>" onsubmit="return confirm('Are you sure you want to regenerate the report?')">
<input type="hidden" value="<?php echo $this->project->id?>" name="projectid" />
<input type="hidden" value="<?php echo $this->model->id?>" name="id" />
