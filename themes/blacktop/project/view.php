...
<div id="parent-links">
    ...
    <a title="Unsubscribe" style="display: <?php echo $deleteStyle?>;" id="delete-project-watch" href="#" onclick="$.get('<?php echo build_url('note', 'deletewatch')?>', {id:'<?php echo $this->project->id?>', type:'<?php echo get_class($this->project)?>'}, function() {$('#delete-project-watch').hide();$('#add-project-watch').show(); }); return false; "><img src="<?php echo resource('images/thumb_down.png')?>"/></a>
	<a title="Subscribe" style="display: <?php echo $addStyle?>;" id="add-project-watch" href="#" onclick="$.get('<?php echo build_url('note', 'addwatch')?>', {id:'<?php echo $this->project->id?>', type:'<?php echo get_class($this->project)?>'}, function() {$('#add-project-watch').hide();$('#delete-project-watch').show(); }); return false; "><img src="<?php echo resource('images/thumb_up.png')?>"/> </a>
...
<div id="project-container">
    <ul class="tab-options">
        ...
        <li><a href="#codereviews"><span id="codereviews-index">Code Reviews</span></a></li>
...
function positionChart()
{
	...
	<div id="codereviews">
	    <?php $this->dispatch('codereview', 'listproject', array('projectid'=>$this->project->id)); ?>
	
	    <p>
		<a class="abutton" href="<?php echo build_url('codereview', 'edit', array('projectid'=>$this->project->id))?>">Add Code Review</a>
	    </p>
	</div>
