...
$options->buttons = array(
	array('name' => 'New', 'bclass' => 'newbutton', 'onpress' => 'function(cmd, data) { Relapse.Clients.newClient(cmd, data) }'),
	array('name' => 'View', 'bclass' => 'viewbutton', 'onpress' => 'function(cmd, data) { Relapse.Clients.openClient(cmd, data) }'),
	array('name' => 'Edit', 'bclass' => 'editbutton', 'onpress' => 'function(cmd, data) { Relapse.Clients.editClient(cmd, data) }'),
	array('name' => 'Delete', 'bclass' => 'deletebutton', 'onpress' => 'function(cmd, data) { Relapse.Clients.deleteClient(cmd, data) }')
);
