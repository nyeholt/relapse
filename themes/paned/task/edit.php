...
<div id="task-container">
	<?php $this->addToPane(build_url('timesheet','detailedTimesheet', array('taskid' => $this->model->id)), '<img class="small-icon" src="'.resource('images/clock_red.png').'" />', 'Timesheet for '.$this->escape($this->model->title), 'RightPane'); ?>
	...
	<?php if ($this->viaajax): ?>
	<input type="button" class="abutton" onclick="Relapse.closeDialog('taskdialog', this)" value="Close" />
	<?php else: ?>
