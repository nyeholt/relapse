<form method="post" action="<?php echo build_url('client', 'save');?>" class="ajaxForm data-form">
...
<?php endif; ?>
	...
	<p class="clear">
		...
		<input type="button" class="abutton" onclick="Relapse.closeDialog('clientdialog', this);" value="Close" />
    </p>
</form>