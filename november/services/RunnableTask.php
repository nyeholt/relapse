...
interface RunnableTask
{
    ...
    /**
     * Optional method for this task to tell the container when it will 
     * run next.
     *
     * @param int $lastRun
     */
    ...
    /**
     * Tell the container how often it should be executed. 
     * 
     * Return 0 from here to have getNextRun called instead. 
     *
     */
